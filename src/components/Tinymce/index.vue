...
export default {
  ...
  props: {
    ...
    url: {
      default: `${BASE_URL}api/post/upload/news`,
      type: String
    },
    accept: {
    ...
    init() {
      ...
      this.Editor = window.tinymce.init({
        ...
        images_upload_handler: function(blobInfo, success, failure) {
          ...
          // console.log('文件类型',blobInfo.blob().type,self.accept.indexOf(blobInfo.blob().type))
          ...
          function uploadPic() {
            ...
            xhr.onload = function() {
              ...
              success(json.result); //成功回调不调用的话将一直处于Loading状态
